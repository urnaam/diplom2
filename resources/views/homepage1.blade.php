	...
	<div class="top-strip">
		<div class="container-fluid">
			...
			<div class="contact-info">
				<ul>
					<li><span class="glyphicon glyphicon-earphone" aria-hidden="true"></span>+976-70150308</li>
					<li><span class="glyphicon glyphicon-envelope" aria-hidden="true"></span><a href="mailto:urnaamgl1105@gmail.com">urnaamgl1105@gmail.com</a></li>
				</ul>
			</div>
			<!-- Large modal -->
	   ...
	   <!-- Collect the nav links, forms, and other content for toggling -->
		<div class="collapse navbar-collapse" id="bs-megadropdown-tabs">
			<ul class="nav navbar-nav nav_1">
				...
				<li class="dropdown">
				<li class="current_page"><a href="#" class="dropdown-toggle" data-toggle="dropdown">Бидний тухай<span class="caret"></span></a>
...
Г.Баясгалан</p>
					...
					<div class="col-md-5 footer three">
			...
			<div class="copy-right-grids">
				<div class="container">
					...
					<div class="footer-links">
						<ul>
							<li><a href="sitemap">Вебийн бүтэц</a></li>
							<li><a href="terms">Журам</a></li>
						</ul>
					</div>
					<div class="clearfix"></div>
				</div>
